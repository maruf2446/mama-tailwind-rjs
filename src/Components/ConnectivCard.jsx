import img1 from "../assets/img/connectiv.png"
import img2 from "../assets/img/conne.svg"

const ConnectivCard = () => {
  return (
    <div className="max-w-[1240px] mx-auto pb-20 px-36">
      <div className=" flex flex-row">
        <figure><img className="h-[550px] w-[850px]" src={img1} alt="Album" /></figure>
        <div className="card-body pl-20 mt-16">
          ...
          <div className="flex flex-row items-center uppercase text-xs font-bold leading-3 tracking-widest pb-4">
            <img className="w-[28px] h-[19px] ml-4" src={img2} alt="" />
